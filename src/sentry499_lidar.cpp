...
bool found_wall_ = false; //needed to determine if we've found a wall yet
...
int main(int argc, char **argv) {
	...
	occupancy_grid_.info.resolution = 0.1; //10 cm resolution
	...
	ros::Subscriber current_state_subscriber_ = nh.subscribe("gazebo_sentry_pose", 1, gazeboPoseCallback);
